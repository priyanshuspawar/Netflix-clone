...
const SimilarPoster = (props:any) => {
    ...
    // console.log(props.item.media_type);
  return (
    ...
    <Text style={{color:"white",fontSize:8,textAlign:"center"}}>{props.item.media_type=="tv" || props.item.first_air_date !=undefined?props.item.name:props.item.title}</Text>
